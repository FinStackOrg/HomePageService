...
def lambda_handler(event, context):
    ...
    binance_accounts = dynamoClient.scan(
        ExpressionAttributeNames=expression_attribute_names,
        ProjectionExpression=projection_expression,
        TableName='binanceAccount'
    ).get("Items",[])
    ...
    try:
        for account in binance_accounts:
            ...
            refresh_url = "https://ji1g9w5p36.execute-api.us-west-1.amazonaws.com/test/binance/refreshdata?api_key={}".format(api_key)
